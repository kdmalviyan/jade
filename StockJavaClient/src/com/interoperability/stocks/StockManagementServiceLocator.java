...
public class StockManagementServiceLocator extends org.apache.axis.client.Service implements com.interoperability.stocks.StockManagementService {
    ...
    private java.lang.String StockManagementPort_address = "http://localhost:8080/aInteroperabilityProjectbc/StockManagement";
    ...
    public com.interoperability.stocks.StockManagement getStockManagementPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.interoperability.stocks.StockManagement getStockManagementPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.interoperability.stocks.StockManagementServiceSoapBindingStub _stub = new com.interoperability.stocks.StockManagementServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.interoperability.stocks.StockManagement.class.isAssignableFrom(serviceEndpointInterface)) {
                com.interoperability.stocks.StockManagementServiceSoapBindingStub _stub = new com.interoperability.stocks.StockManagementServiceSoapBindingStub(new java.net.URL(StockManagementPort_address), this);
                _stub.setPortName(getStockManagementPortWSDDServiceName());
                return _stub;
            }
        }

...
public class StockManagementProxy implements com.interoperability.stocks.StockManagement {
	...
	private void _initStockManagementProxy() {
		try {
			stockManagement = (new com.interoperability.stocks.StockManagementServiceLocator())
					.getStockManagementPort();
			if (stockManagement != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) stockManagement)._setProperty("javax.xml.rpc.service.endpoint.address",
							_endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) stockManagement)

...
case 16:
        gotMethod = true;
        String arg0_1id=  request.getParameter("arg037");
...
<%
if(getStock16mtemp != null){
java.lang.String typesymbol23 = getStock16mtemp.getSymbol();
        String tempResultsymbol23 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(typesymbol23));
        %>
        <%= tempResultsymbol23 %>
        <%
}%>
...
<%
if(getStock16mtemp != null){
java.lang.String typesecurity31 = getStock16mtemp.getSecurity();
        String tempResultsecurity31 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(typesecurity31));
        %>
        <%= tempResultsecurity31 %>
        <%
}%>
</TD>
<TR>
